...
# For loading ConnectE embedding model For FB15 Dataset
...
def load_dataset(PATH, Embedding_Path, top_types):
    ...
    freebase_ttrain=pd.read_csv(PATH+'/FB15k_Entity_Type_train.txt', sep='\t', header=None, index_col=0)
    freebase_ttest=pd.read_csv(PATH+'/FB15k_Entity_Type_test.txt', sep='\t', header=None, index_col=0)
    freebase_tvalid=pd.read_csv(PATH+'/FB15k_Entity_Type_valid.txt', sep='\t', header=None, index_col=0)
    ...
    embedding_filter={} # filtered vectors 
    y_dict={}
